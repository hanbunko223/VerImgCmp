...
impl<E: Engine> PolyEvalWitness<E> {
  /// Constructs a polynomial evaluation witness from polynomial evaluations.
  ...
  pub(crate) fn batch_diff_size(W: Vec<PolyEvalWitness<E>>, s: E::Scalar) -> PolyEvalWitness<E> {
...
impl<E: Engine> PolyEvalInstance<E> {
  /// Constructs a polynomial evaluation instance.
